    ...
    <div class="mx-auto flex max-w-4xl flex-col gap-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <h1 class="mt-1 text-2xl font-semibold text-foreground sm:text-3xl">Add new grade</h1>
        ...
        <form wire:submit="save" class="overflow-hidden rounded-xl border border-card-line bg-card shadow-2xs">
            <div class="border-b border-card-line bg-muted/50 px-5 py-4 sm:px-6">
                <h2 class="text-base font-semibold text-foreground">Add Grade</h2>
