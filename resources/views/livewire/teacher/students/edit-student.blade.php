    ...
    <div class="mx-auto flex max-w-4xl flex-col gap-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <h1 class="mt-1 text-2xl font-semibold text-foreground sm:text-3xl">Edit student</h1>
                <p class="mt-2 max-w-2xl text-sm text-muted-foreground-2">
                    Update {{ $student->first_name }} {{ $student->last_name }}'s profile and grade placement.
                </p>
            </div>
