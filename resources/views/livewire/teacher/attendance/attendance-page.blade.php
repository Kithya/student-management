                ...
                <div class="p-1.5 min-w-full inline-block align-middle">
                    <div class="bg-layer border border-layer-line rounded-xl shadow-2xs overflow-hidden">
                        <div
                            ...
                            <div
                                class="grid w-full grid-cols-1 gap-2 sm:grid-cols-[minmax(8rem,1fr)_minmax(10rem,1fr)_minmax(10rem,1fr)_auto_auto] lg:w-auto">
                                ...
                                <button type="button" wire:click="exportToExcel()"
                                    class="inline-flex h-10 w-full items-center justify-center gap-1 rounded-lg border border-emerald-200 bg-emerald-50 px-4 text-sm font-medium text-emerald-700 shadow-2xs transition hover:-translate-y-0.5 hover:border-emerald-300 hover:bg-emerald-100 hover:text-emerald-800 hover:shadow-sm focus:outline-hidden focus:ring-2 focus:ring-emerald-500/30 disabled:pointer-events-none disabled:opacity-50 sm:w-auto dark:border-emerald-400/30 dark:bg-emerald-400/10 dark:text-emerald-300 dark:hover:bg-emerald-400/20">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
