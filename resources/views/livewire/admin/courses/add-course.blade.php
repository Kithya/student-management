<div class="max-w-4xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <div class="mb-6 flex items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-semibold text-foreground sm:text-3xl">Add course</h1>
            <p class="mt-2 text-sm text-muted-foreground-2">Create a course subject and optionally assign a teacher.</p>
        </div>
    ...
    <form wire:submit="save" class="bg-layer border border-layer-line rounded-lg p-6 shadow-2xs space-y-6">
        <div class="grid gap-5 sm:grid-cols-2">
            <flux:input wire:model="code" label="Code" type="text" required placeholder="MATH-101" />
            <flux:input wire:model="name" label="Subject name" type="text" required placeholder="Mathematics" />
        </div>
        ...
        <flux:textarea wire:model="description" label="Description" rows="4" placeholder="Course notes or focus areas" />
